package com.imilia.mall.product.exception;

import com.imilia.common.exception.BizCodeEnum;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.imilia.mall.product.controller")
